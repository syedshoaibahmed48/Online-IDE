...
const AuthPage = () => {
    ...
    const selectedButtonStyle = "h-10 w-36 bg-[#e0195bff] hover:bg-green-600 flex flex-wrap items-center text-lg text-white justify-center";
    const unSelectedButtonStyle = "h-10 w-36 bg-[#120013ff] hover:bg-gray-900 flex flex-wrap items-center text-lg font-normal border-2 border-[#e0195bff] text-white justify-center";

  return (
    <div class="flex flex-col">
    <Toast />
      <header class="sticky top-0 bg-[#210423ff]">
        <div class="container mx-auto flex flex-wrap p-0.25 flex-col md:flex-row items-center">
          <div class="ml-24 mt-2 mb-2 w-48 ">
            <a
              href="/"
              class="flex title-font font-normal items-center text-gray-900 mb-4 md:mb-0"
            >
              <img src={ new URL (`../assets/logo.png`, import.meta.url)} alt="unavailable" />
            </a>
          </div>
          <nav class="md:ml-auto md:mr-20 flex space-x-20 flex-wrap items-center text-xl justify-center">
            <button className={ formType=== "signin" ? selectedButtonStyle : unSelectedButtonStyle } onClick={()=>{changeFormType("signin")}}>
              Login
            </button>
            <button className={ formType=== "signin" ? unSelectedButtonStyle : selectedButtonStyle } onClick={()=>{changeFormType("signup")}}>
              SignUp
            </button>
          </nav>
        </div>
      </header>
      <div class="bg-[#120013ff] py-10 h-screen">
        <section class="ml-20 text-gray-600 body-font">
          <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
            <div class=" mx-28 lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
              <img
